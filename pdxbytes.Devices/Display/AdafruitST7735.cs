...
namespace pdxbytes.Devices.Display
{
  ...
  uint16_t Color565(uint8_t r, uint8_t g, uint8_t b);
     */
    /// <summary>
    /// netduino ST7735 driver (based on AdaFruit's library https://github.com/adafruit/Adafruit-ST7735-Library)
    /// </summary>
    public class AdafruitST7735 : BaseTFT
    {

        //public new const byte Width = 128;
        //public new const byte Height = 160;
        ...
        //public OutputPort Reset { get; set; }
        ...
        private void SetAddressWindow(byte x0, byte y0, int x1, int y1)
        {
            DataCommand.Write(Command);
            Write((byte)LcdCommand.CASET);  // column addr set
            DataCommand.Write(Data);
        ...
        public readonly byte[] SpiBuffer;
